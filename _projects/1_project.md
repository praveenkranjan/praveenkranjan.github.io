...
<center>
    {% include figure.liquid loading="eager" path="assets/img/flex_form/flex_form_web_1.gif" title="example image" class="img-fluid rounded z-depth-1" style="display: block; width: 60%; margin: auto; align:center" %}
</center>
