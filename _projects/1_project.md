...
<center style="width: 60; height:auto; align:center;">
    {% include figure.liquid loading="eager" path="assets/img/flex_form/flex_form_web_1_r1.gif" title="example image" class="img-fluid rounded z-depth-1"  %}
</center>
