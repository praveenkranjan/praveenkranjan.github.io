...
<div class="row">
    {% include figure.liquid loading="eager" path="assets/img/flex_form/flex_form_web_1.gif" title="example image" class="img-fluid rounded z-depth-1" style="max-width: 100%; height: auto;" %}
</div>
<div class="caption">
