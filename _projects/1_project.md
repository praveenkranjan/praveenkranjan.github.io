...
<div class="row justify-content-sm-center">
    {% include figure.liquid path="assets/img/flex_form/flex_form_web_1.gif" title="example image" class="img-fluid rounded z-depth-1" style="max-width: 100px; height: auto;" %}
    <div class="caption">
