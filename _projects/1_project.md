...
<div class="row">
    {% include figure.liquid loading="eager" path="assets/img/flex_form/flex_form_web_1_v2.gif" title="example image" class="img-fluid rounded z-depth-1" style="display: block; width: 60%; margin: auto;" %}
</div>
<div class="caption">
