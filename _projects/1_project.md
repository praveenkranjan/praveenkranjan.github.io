...
<div class="row">
    {% include figure.liquid loading="eager" path="assets/img/flex_form/flex_form_web_1_v2.gif" title="example image" class="img-fluid rounded z-depth-1" style="width: 100px; height: 100px;" %}
</div>
<div class="caption">
