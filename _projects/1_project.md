...
<div class="row">
    <img src="assets/img/flex_form/flex_form_web_1.gif" alt="example image" style="width: 200px; height: auto;" class="img-fluid rounded z-depth-1">
</div>
<div class="caption">
    FBFM with different desired bearing angles. 
</div>
<div class="row">
    {% include figure.liquid loading="eager" path="assets/img/flex_form/flex_form_web_1.gif" title="example image" class="img-fluid rounded z-depth-1" style="width: 10px; height: auto;" %}
</div>
<div class="caption">
    FBFM with different desired bearing angles. 
</div>
